...
class LibheifConan(ConanFile):
    ...
    def generate(self):
        ...
        if Version(self.version) < "1.23.4":
        ...
        openh264_option = "WITH_OPENH264_DECODER" if Version(self.version) < "1.23.4" else "WITH_OpenH264_DECODER"
        tc.cache_variables[openh264_option] = self.options.get_safe("with_openh264", False)
